...
val adsModule : Module = module {
    ...
    single<AdsConfig>(named(name = "apps_list_banner_ad")) {
        AdsConfig(bannerAdUnitId = AdsConstants.APPS_LIST_BANNER_AD_UNIT_ID , adSize = AdSize.MEDIUM_RECTANGLE)
    }

    single<AdsConfig>(named(name = "no_data_banner_ad")) {
        AdsConfig(bannerAdUnitId = AdsConstants.NO_DATA_MEDIUM_RECTANGLE_BANNER_AD_UNIT_ID , adSize = AdSize.LARGE_BANNER)
    }
    ...
    single<AdsConfig>(named(name = "support_banner_ad")) {
        AdsConfig(bannerAdUnitId = AdsConstants.SUPPORT_MEDIUM_RECTANGLE_BANNER_AD_UNIT_ID , adSize = AdSize.LARGE_BANNER)
    }
}