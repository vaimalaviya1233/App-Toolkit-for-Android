...
sealed interface Errors : Error {
    ...
    enum class UseCase : Errors {
        NO_DATA , FAILED_TO_LAUNCH_REVIEW , FAILED_TO_LOAD_FAQS , FAILED_TO_REQUEST_REVIEW , FAILED_TO_IMPORT_CART , FAILED_TO_DECRYPT_CART , FAILED_TO_UPDATE_APP , FAILED_TO_LOAD_SKU_DETAILS , FAILED_TO_LOAD_CONSENT_INFO
    }
