package com.d4rk.android.libs.apptoolkit.utils.constants.error
/**
 ...
 * @brief An error related to security, such as unauthorized access.
 *
 * @var IO_EXCEPTION
 * @brief An error related to input/output operations, such as file access issues.
 *
 * @var ACTIVITY_NOT_FOUND
 * @brief An error indicating that a requested activity or resource could not be found.
 *
 * @var ILLEGAL_ARGUMENT
 * @brief An error due to an invalid or inappropriate argument passed to a function.
 *
 * @var SQLITE_EXCEPTION
 * @brief An error specific to SQLite database operations.
 *
 * @var UNKNOWN_ERROR
 * @brief A generic error that doesn't fit into the other defined categories. Should be avoided if possible,
 *        and specific errors should be created instead.
 */
