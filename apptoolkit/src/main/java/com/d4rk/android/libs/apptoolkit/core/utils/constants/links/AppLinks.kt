...
object AppLinks {
    ...
    // Legal & Policy
    private const val GOOGLE_SITES_BASE : String = "https://sites.google.com/view/d4rk7355608/"
    const val ADS_HELP_CENTER : String = "${GOOGLE_SITES_BASE}more/apps/ads-help-center"
    const val PRIVACY_POLICY : String = "${GOOGLE_SITES_BASE}more/apps/privacy-policy"
    const val TERMS_OF_SERVICE : String = "${GOOGLE_SITES_BASE}more/apps/terms-of-service"
    const val CODE_OF_CONDUCT : String = "${GOOGLE_SITES_BASE}more/code-of-conduct"
    const val LEGAL_NOTICES : String = "${GOOGLE_SITES_BASE}more/apps/legal-notices"
